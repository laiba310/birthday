    ...
    <div className="min-h-screen bg-gradient-to-b from-pink-100 via-white to-pink-200 flex flex-col items-center justify-center p-6 text-center relative overflow-hidden">
      ...
      {blown && (
        <div className="mt-12 max-w-xl text-lg text-gray-700 bg-white p-6 rounded-3xl shadow-xl animate-fade-in z-10 border-4 border-pink-200">
          ...
          <p>
         Hehehee I hope tumhe yeh pasand aayi 🥺💗
Not so creative, but I tried my best... ✨
Happy Birthday jaanuuu 🎂🎉
Hamesha khush raho, sath raho, aur ily soooo muchhh 🥹🌈   
Soo januuu, I'm very lucky that you're my best friend 🌸
Like, tumne hamesha har jagah meri madad ki 💫
Jab bhi low ho jaati hoon ya jab kuch samajh nahi aata hota —
You're always the only one there for me 💕
